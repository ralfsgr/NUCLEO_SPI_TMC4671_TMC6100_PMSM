// this is only needed in TMCL for open loop testing for set up of pole pairs and direction
// there is no offset magic number that is needed to be saved
// the rotor snaps in known position by moving rotor alligment with stator magnetic field
// use TMC4671 API
